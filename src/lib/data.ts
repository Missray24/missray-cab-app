...
export const drivers: Driver[] = [
  { id: 'DRV-001', firstName: 'Bob', lastName: 'Williams', email: 'bob@example.com', phone: { countryCode: '+33', number: '601020301' }, company: { name: 'Bob Transports', address: '1 rue de la Paix, Paris', siret: '12345678901234', vatNumber: 'FR123456789', evtcAdsNumber: 'EVTC12345' }, vehicle: { brand: 'Toyota', model: 'Camry', licensePlate: 'DRV-123', registrationDate: '2022-01-15' }, status: 'Active', totalRides: 120, totalEarnings: 3250.50, unpaidAmount: 450.00, paymentDetails: { method: 'Bank Transfer', account: 'FR76...XX' }, documents: [{ name: "Permis de conduire", url: "https://placehold.co/600x400.png", status: 'Approved' }, { name: 'Carte grise', url: 'https://placehold.co/600x400.png', status: 'Approved' }] },
  { id: 'DRV-002', firstName: 'Diana', lastName: 'Prince', email: 'diana@example.com', phone: { countryCode: '+33', number: '601020302' }, company: { name: 'Prince VTC', address: '2 avenue des Champs, Paris', siret: '23456789012345', vatNumber: 'FR234567890', evtcAdsNumber: 'EVTC23456' }, vehicle: { brand: 'Honda', model: 'Accord', licensePlate: 'DRV-456', registrationDate: '2021-11-20' }, status: 'Active', totalRides: 95, totalEarnings: 2890.75, unpaidAmount: 210.50, paymentDetails: { method: 'PayPal', account: 'diana.p@email.com' }, documents: [{ name: "Permis de conduire", url: "https://placehold.co/600x400.png", status: 'Pending' }] },
  { id: 'DRV-003', firstName: 'Frank', lastName: 'White', email: 'frank@example.com', phone: { countryCode: '+33', number: '601020303' }, company: { name: 'White Cars', address: '3 place de la Concorde, Paris', siret: '34567890123456', vatNumber: 'FR345678901', evtcAdsNumber: 'ADS78910' }, vehicle: { brand: 'Ford', model: 'Fusion', licensePlate: 'DRV-789', registrationDate: '2023-02-10' }, status: 'Suspended', totalRides: 50, totalEarnings: 1500.00, unpaidAmount: 0, paymentDetails: { method: 'Bank Transfer', account: 'FR76...YY' }, documents: [] },
  { id: 'DRV-004', firstName: 'Henry', lastName: 'Green', email: 'henry@example.com', phone: { countryCode: '+33', number: '601020304' }, company: { name: 'Green Drive', address: '4 rue du Faubourg, Paris', siret: '45678901234567', vatNumber: 'FR456789012', evtcAdsNumber: 'EVTC45678' }, vehicle: { brand: 'Chevrolet', model: 'Malibu', licensePlate: 'DRV-101', registrationDate: '2020-07-30' }, status: 'Active', totalRides: 150, totalEarnings: 4100.20, unpaidAmount: 850.70, paymentDetails: { method: 'Bank Transfer', account: 'FR76...ZZ' }, documents: [{ name: "Permis de conduire", url: "https://placehold.co/600x400.png", status: 'Approved' }, { name: 'Carte grise', url: 'https://placehold.co/600x400.png', status: 'Rejected' }] },
  { id: 'DRV-005', firstName: 'Jack', lastName: 'Black', email: 'jack@example.com', phone: { countryCode: '+33', number: '601020305' }, company: { name: 'JB Transport', address: '5 boulevard Haussmann, Paris', siret: '56789012345678', vatNumber: 'FR567890123', evtcAdsNumber: 'ADS89012' }, vehicle: { brand: 'Tesla', model: 'Model 3', licensePlate: 'DRV-212', registrationDate: '2023-05-20' }, status: 'Active', totalRides: 200, totalEarnings: 5500.00, unpaidAmount: 1200.00, paymentDetails: { method: 'PayPal', account: 'jack.b@email.com' }, documents: [{ name: "Permis de conduire", url: "https://placehold.co/600x400.png", status: 'Pending' }] },
];
