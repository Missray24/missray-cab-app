...
export const drivers: Driver[] = [
  { id: 'DRV-001', name: 'Bob Williams', email: 'bob@example.com', phone: '555-0201', vehicle: 'Toyota Camry', licensePlate: 'DRV-123', status: 'Active', totalRides: 120, totalEarnings: 3250.50, unpaidAmount: 450.00, paymentDetails: { method: 'Bank Transfer', account: 'FR76...XX' }, documents: [{ name: "Permis de conduire", url: "https://placehold.co/600x400.png" }, { name: 'Carte grise', url: 'https://placehold.co/600x400.png' }] },
  { id: 'DRV-002', name: 'Diana Prince', email: 'diana@example.com', phone: '555-0202', vehicle: 'Honda Accord', licensePlate: 'DRV-456', status: 'Active', totalRides: 95, totalEarnings: 2890.75, unpaidAmount: 210.50, paymentDetails: { method: 'PayPal', account: 'diana.p@email.com' }, documents: [{ name: "Permis de conduire", url: "https://placehold.co/600x400.png" }] },
  { id: 'DRV-003', name: 'Frank White', email: 'frank@example.com', phone: '555-0203', vehicle: 'Ford Fusion', licensePlate: 'DRV-789', status: 'Suspended', totalRides: 50, totalEarnings: 1500.00, unpaidAmount: 0, paymentDetails: { method: 'Bank Transfer', account: 'FR76...YY' }, documents: [] },
  { id: 'DRV-004', name: 'Henry Green', email: 'henry@example.com', phone: '555-0204', vehicle: 'Chevrolet Malibu', licensePlate: 'DRV-101', status: 'Active', totalRides: 150, totalEarnings: 4100.20, unpaidAmount: 850.70, paymentDetails: { method: 'Bank Transfer', account: 'FR76...ZZ' }, documents: [{ name: "Permis de conduire", url: "https://placehold.co/600x400.png" }, { name: 'Carte grise', url: 'https://placehold.co/600x400.png' }] },
  { id: 'DRV-005', name: 'Jack Black', email: 'jack@example.com', phone: '555-0205', vehicle: 'Tesla Model 3', licensePlate: 'DRV-212', status: 'Active', totalRides: 200, totalEarnings: 5500.00, unpaidAmount: 1200.00, paymentDetails: { method: 'PayPal', account: 'jack.b@email.com' }, documents: [{ name: "Permis de conduire", url: "https://placehold.co/600x400.png" }] },
];
