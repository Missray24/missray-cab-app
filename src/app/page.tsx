  ...
  return (
    <div className="flex flex-col min-h-dvh">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48 bg-gradient-to-br from-primary to-[hsl(231,50%,70%)]">
              ...
              <div className="flex items-center">
                <div className="bg-card p-6 rounded-lg shadow-lg w-full max-w-md">
                  <div className="space-y-4">
                    ...
                    <Button size="lg" className="w-full h-12 text-base text-primary-foreground bg-gradient-to-r from-[hsl(231,48%,38%)] to-primary transition-opacity hover:opacity-90">
                      Voir les véhicules
                    </Button>
                  </div>
                </div>
