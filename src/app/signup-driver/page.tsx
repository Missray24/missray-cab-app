...
export default function SignupDriverPage() {
  ...
  const formSchema = z
    .object({
      ...
      companyAddress: z.string().min(1, "L'adresse de la société est requise"),
    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-r from-[#223aff] to-[#1697ff] p-4">
      <Card className="w-full max-w-lg">
        <CardHeader className="text-center">
          ...
          <CardDescription>
            {step === 1 ? "Étape 1/2 : Vos informations personnelles." : "Étape 2/2 : Informations sur votre entreprise."}
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              <div className={cn(step !== 1 && "hidden")}>
                ...
                <FormField
                    ...
                    name="phone"
                    render={({ field }) => (
                      <FormItem className="flex flex-col gap-1.5 mt-4">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl><Input placeholder="Ex: Dupont Transports" {...field} /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                   <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl><Input placeholder="123 Rue de la République, 75001 Paris" {...field} /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
                   ...
                   <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl><Input placeholder="EVTC123456789" {...field} /></FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  />
