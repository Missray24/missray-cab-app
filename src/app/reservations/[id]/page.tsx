               ...
               <div className="grid md:grid-cols-2 gap-4">
                 <div>
                    ...
                    <div className="space-y-1">
                        <p className="font-medium">Total: {reservation.totalAmount.toFixed(2)}€ ({reservation.paymentMethod})</p>
                        <p className="text-xs text-muted-foreground">
                            (HT: {reservation.amount.toFixed(2)}€ + TVA: {reservation.vatAmount.toFixed(2)}€)
                        </p>
                    </div>
                 </div>
                 <div>
